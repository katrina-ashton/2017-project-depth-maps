...
% varn0 = 'var';
% 
% move_func(typeb, typem, R0, h0, R, h, 20, fovt, fovp, 1, p1n0, p2n0, sse1n0, sse2n0, varn0, 0, modflag)
% close all;
% 
...
%     move_func(typeb, typem, R0, h0, R, h, N, fovt, fovp, scale, p1n, p2n, sse1n, sse2n, varn, 0, modflag)
%     close all;
% end
...
% %     move_func(typeb, typem, R0, h0, R, h, N, fovt, fovp, 1, p1n, p2n, sse1n, sse2n, varn, 0, modflag)
% %     close all;
% % end
% 
% typeb = 'sphere';
...
%     move_func(typeb, typem, R0, h0, R, h, N, fovt, fovp, 1, p1n, p2n, sse1n, sse2n, varn, uncer, modflag)
%     close all;
% end
...
%     sse2n = ['R',sse2n0,num2str(i)];
%     varn = ['R',varn0,num2str(i)];
%     move_func(typeb, typem, R0, h0, R, h, N, fovt, fovp, 1, p1n, p2n, sse1n, sse2n, varn, 0, 2000, modflag)
%     close all;
% end
% 
% %%%
...
%     move_func(typeb, typem, R0, h0, R, h, N, 40, fovt, fovp, 1, p1n, p2n, sse1n, sse2n, varn, 0, nmeas, modflag)
%     close all;
% end
% 
% for i=1:numel(ns)
...
%     move_func(typeb, typem, R0, h0, R, h, N, n, fovt, fovp, 1, p1n, p2n, sse1n, sse2n, varn, 0, 2000, modflag)
%     close all;
% end
% 
% %%%FOV%%%
...
%     move_func(typeb, typem, R0, h0, R, h, N, 40, fovt, fovp, 1, p1n, p2n, sse1n, sse2n, varn, 0, 5000, modflag)
%     close all;
% end
...
% sse2n = ['T',sse2n0];
% varn = ['T',varn0];
% move_func(typeb, typem, R0, h0, R, h, N, 40, fovt, fovp, 1, p1n, p2n, sse1n, sse2n, varn, 0, 2000, 0)
