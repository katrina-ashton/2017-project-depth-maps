function [base, test] = generate_base(type, nenv, nbase, varargin)
if strcmp(type,'cylinder')
    ...
    nr = int32(nenv/((Ac/Ar)+1)); %Number of points in rectangle
    nc = int32((nenv - nr)/2);    %Number of points in each circle
